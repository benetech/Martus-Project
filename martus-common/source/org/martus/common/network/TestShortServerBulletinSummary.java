...
public class TestShortServerBulletinSummary extends TestCaseEnhanced
{
	public TestShortServerBulletinSummary(String name)
	{
		super(name);
	}
	...
	public void testBasics()
	{
		...
		assertEquals(localId, summary.getLocalId());
