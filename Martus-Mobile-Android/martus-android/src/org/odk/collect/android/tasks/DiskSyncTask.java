...
public class DiskSyncTask extends AsyncTask<Void, String, String> {
    ...
    protected String doInBackground(Void... params) {
    	...
    	try {
	        ...
	        if (formDir.exists() && formDir.isDirectory()) {
		        ...
		        try {
		            mCursor = MartusApplication.getInstance().getContentResolver()
	        ...
	        if ( errors.length() != 0 ) {
	        	...
	        	statusMessage = MartusApplication.getInstance().getString(R.string.finished_disk_scan);
	        }
    ...
    private boolean isAlreadyDefined(File formDefFile) {
        ...
        Cursor c = null;
        try {
        	c = MartusApplication.getInstance().getContentResolver()
    ...
    public ContentValues buildContentValues(File formDefFile) throws IllegalArgumentException {
        ...
        if (title != null) {
        	...
        	throw new IllegalArgumentException(MartusApplication.getInstance().getString(R.string.xform_parse_error,
