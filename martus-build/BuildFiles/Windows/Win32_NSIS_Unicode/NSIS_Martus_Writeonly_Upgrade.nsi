...
preserve_existing_shortcuts:
    ...
    CreateShortCut "$SMPROGRAMS\Martus\Martus.lnk" "$MARTUS_INSTALLATION_DIR\bin\javaw.exe" "-Xms256m -Xmx512m -jar $MARTUS_INSTALLATION_DIR\martus.jar --writeonly" "$MARTUS_INSTALLATION_DIR\app.ico" 0 "" "" "$(MartusShortcutDescription_Text)"
...
lbl_no_startmenu_shortcut:
    CreateShortCut "$MARTUS_INSTALLATION_DIR\Martus.lnk" "$MARTUS_INSTALLATION_DIR\bin\javaw.exe" "-Xms256m -Xmx512m $MARTUS_INSTALLATION_DIR\martus.jar --writeonly" "$MARTUS_INSTALLATION_DIR\app.ico" 0 "" "" "$(MartusShortcutDescription_Text)"
