name = 'martus-client-writeonly-mac-dmg'
...
define name, :layout=>create_layout_with_source_as_source('.') do
  ...
  file dmg_file => production_zipfile do
    ...
    buildfile = _('martus-build', 'martus-client-writeonly-mac-dmg.ant.xml')
    ...
    destination_filename = "MartusClient-WriteOnly-#{project.version}-#{input_build_number}-#{release_build_number}.dmg"
