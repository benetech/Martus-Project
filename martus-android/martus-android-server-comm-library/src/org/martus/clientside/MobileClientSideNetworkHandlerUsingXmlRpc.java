	...
	extends ClientSideNetworkHandlerUsingXmlRpc
{
	...
	public MobileClientSideNetworkHandlerUsingXmlRpc(String serverName, int[] portsToUse, PassThroughTransportWrapper transportToUse) throws SSLSocketSetupException	{
	...
	public Object executeXmlRpc(String serverName, String method, Vector params, int port) throws Exception
	{
		...
		XmlRpcTransportFactory transportFactory = getTransport().createTransport(client, getSimpleX509TrustManager());
